    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form action="/app/recipe/add" method="post">
            <div class="mt-4 ml-4 mr-4">
                ...
                <table class="table borderless">
                    ...
                    <tr class="d-flex">
                        ...
                        <td class="col-7">
                            ...
                            <input id= "name" name="name" class="w-100 p-1" value="">
                        </td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Opis przepisu</th>
                        <td class="col-7"><textarea id="description" name="description" class="w-100 p-1" rows="5"></textarea></td>
                    </tr>
                    <tr class="d-flex">
                        <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                        <td class="col-3">
                            <input id="preparationTime" name="preparationTime" class="p-1" type="number" value="">
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div class="row d-flex">
                    <div class="col-5 p-4">
                        <textarea id="preparation" name="preparation" class="w-100 p-1" rows="10"></textarea>
                    </div>
                    <div class="col-2"></div>
