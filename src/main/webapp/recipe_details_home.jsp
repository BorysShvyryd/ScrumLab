        ...
        <div class="border-dashed view-height w-100">
            <div class="mt-4 ml-4 mr-4">
                <div class="row border-bottom border-3">
                    ...
                    <div class="col d-flex justify-content-end mb-2"><a href="javascript:history.go(-1)"
                ...
                <div class="row d-flex">
                    <div class="col-5 p-4">
                        <p>${details.getPreparation()}</p>
                    </div>
                    <div class="col-2"></div>
                    <ul class="col-5 p-4 list-unstyled">
                        <c:forEach var="ingredient" items="${details.ingredients.split(\",\")}">
                            <li>${ingredient}</li>
                        </c:forEach>
                    </ul>
                </div>
