    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        <div class="mt-4 ml-4 mr-4">
            <div class="row border-bottom border-3">
                ...
                <div class="col d-flex justify-content-end mb-2"><a href="javascript:history.go(-1)" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Powrót</a></div>
            </div>
            ...
            <div class="row d-flex">
                ...
                <ul class="col-5 p-4 list-unstyled">
                    <c:forEach var="ingredient" items="${recipe.ingredients.split(\",\")}">
                        <li>${ingredient}</li>
                    </c:forEach>
                </ul>
            </div>
